    ...
    let problem = Problem {
        ...
        fleet: Fleet {
            vehicles: vec![VehicleType {
                limits: Some(VehicleLimits { max_distance: Some(99.), max_duration: None, max_activity_duration: None, tour_size: None }),
    ...
    let problem = Problem {
        ...
        fleet: Fleet {
            vehicles: vec![VehicleType {
                ...
                limits: Some(VehicleLimits { max_distance: Some(9.), max_duration: None, max_activity_duration: None, tour_size: None }),
                ..create_default_vehicle_type()
            }],
            ..create_default_fleet()
        },
