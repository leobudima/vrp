...
pub fn can_check_shift_and_distance_limit_impl(
    ...
    let problem = create_test_problem(Some(VehicleLimits { max_distance, max_duration, max_activity_duration: None, tour_size: None }));
    let solution =
...
pub fn can_check_tour_size_limit() {
    let problem =
        create_test_problem(Some(VehicleLimits { max_distance: None, max_duration: None, max_activity_duration: None, tour_size: Some(2) }));
